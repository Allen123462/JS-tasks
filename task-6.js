// Написати скрипт який просить відвідувача ввести число до prompt до тих пір,
...
// при цьому результат prompt плюсувати до загальної суми не потрібно, після чого знову користувачеві пропонується 
